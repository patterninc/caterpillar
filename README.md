...
defers acknowledgment — SQS read mode ([Message Acknowledgment and Delivery Modes](internal/pkg/pipeline/task/sqs/README.md#message-acknowledgment-and-delivery-modes); default `delivery: at-least-once`)
or Kafka group read mode ([Message acknowledgment](internal/pkg/pipeline/task/kafka/README.md#message-acknowledgment-group-read-mode)) —
...
see [SQS Message Acknowledgment and Delivery Modes](internal/pkg/pipeline/task/sqs/README.md#message-acknowledgment-and-delivery-modes)
and [Kafka Message acknowledgment](internal/pkg/pipeline/task/kafka/README.md#message-acknowledgment-group-read-mode).
