...
- Per-task `README.md` under all 21 `internal/pkg/pipeline/task/*/` directories documents each task's config surface — a repeatable convention that gives agents (and humans) a predictable place to look, well beyond what item 6 rewards.
